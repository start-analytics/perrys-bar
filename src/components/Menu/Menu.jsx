  ...
  return (
    <section id="menu" className="menu section">
      ...
      <div
        ...
        data-default-filter=".filter-shisha"
        data-layout="masonry"
      ...
      >
        ...
        <div className="row isotope-container">
          <MenuItem
            ...
            price="$20"
            description="A refreshing blend of pineapple, mango, and coconut with a hint of mint."
            filter="filter-shisha"
          />
          <MenuItem
            url={alf_logo}
            title="Mystic Melon"
            price="$18"
            description="Sweet watermelon fused with a touch of cooling menthol."
            filter="filter-shisha"
          />
          <MenuItem
            url={alf_logo}
            title="Rose Delight"
            price="$22"
            description="Aromatic rose petals with subtle citrus undertones."
            filter="filter-shisha"
          />
          <MenuItem
            url={alf_logo}
            title="Blueberry Mist"
            price="$19"
            description="Juicy blueberries combined with a refreshing hint of mint."
            filter="filter-shisha"
          />
          <MenuItem
            url={alf_logo}
            title="Citrus Burst"
            price="$21"
            description="A zesty mix of lemon, orange, and grapefruit flavors."
            filter="filter-shisha"
          />
          <MenuItem
            url={crab}
            title="Mango Mojito"
            price="$8"
            description="A zesty mix of fresh mango, lime, mint leaves, and soda."
          ...
          <MenuItem
            ...
            title="Berry Bliss"
            price="$7"
            description="A luscious blend of strawberries, blueberries, and raspberries."
            filter="filter-drinks"
          />
          <MenuItem
            url={crab}
            title="Citrus Sparkle"
            price="$6"
            description="Orange, lemon, and lime juice with a splash of soda."
            filter="filter-drinks"
          />
          <MenuItem
            url={crab}
          ...
          <MenuItem
            ...
            title="Vanilla Latte"
            price="$6"
            description="Smooth espresso mixed with creamy vanilla syrup and steamed milk."
            filter="filter-drinks"
          />
          <MenuItem
            url={crab}
          ...
          <MenuItem
            ...
            title="Spicy Wings"
            price="$12"
            description="Juicy chicken wings coated in a fiery sauce."
            filter="filter-snacks"
          />
          <MenuItem
            url={crab}
            title="Garlic Bread"
            price="$8"
            description="Warm baguette slices infused with garlic butter."
            filter="filter-snacks"
          />
          <MenuItem
            url={crab}
            ...
            price="$11"
            description="Mushrooms filled with creamy cheese and herbs, baked to perfection."
            filter="filter-snacks"
          />
          <MenuItem
            url={crab}
            title="Onion Rings"
            price="$9"
            description="Crispy golden onion rings served with a tangy dipping sauce."
            filter="filter-snacks"
          />
        </div>
      </div>
